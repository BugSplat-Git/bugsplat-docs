...
Crash report grouping rules can be changed on the [Group Rules](https://app.bugsplat.com/v2/rules) page or by expanding a stack frame on the **Crash** page and selecting **Group Rules.**&#x20;
