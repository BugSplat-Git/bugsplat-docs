...
To manually upload a crash report, browse for the zip file using the **Select files** link or drag and drop the file on the [Crash Upload](https://app.bugsplat.com/v2/upload) page.
