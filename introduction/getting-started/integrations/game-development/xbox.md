...
To request access to the BugSplat SDK, navigate to the [Microsoft Games middleware request page](https://developer.microsoft.com/en-us/games/support/request-gdkx-middleware), select **BugSplat** from the Middleware Partner dropdown, and submit your request. Once Microsoft processes your request and access is granted, BugSplat will deliver the SDK download package and instruction set via the Gaming Consoles tab on the [Database Integrations](https://app.bugsplat.com/v2/database/integrations) page.
