...
To enable uploading of plugin symbols, generate a Client ID and Client Secret on the BugSplat [Integrations](https://app.bugsplat.com/v2/database/integrations) page. Add your Client ID and Client Secret to the `BugSplatOptions` object you generated in the [Configuration](https://openupm.com/packages/com.bugsplat.unity/?subPage=readme#%E2%9A%99%EF%B8%8F-configuration) section. Once configured, plugins will be uploaded automatically the next time you build your project.
