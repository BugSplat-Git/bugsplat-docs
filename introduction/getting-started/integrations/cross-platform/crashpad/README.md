...
The first step to integrating Crashpad is to configure your build process. BugSplat provides pre-built versions of Crashpad that are updated monthly. You can find the prebuilt libraries on the [Releases](https://github.com/BugSplat-Git/bugsplat-crashpad) page in the [bugsplat-crashpad](https://github.com/BugSplat-Git/bugsplat-crashpad/releases) repo. The [bugsplat-crashpad](https://github.com/BugSplat-Git/bugsplat-crashpad) repo also includes scripts that demonstrate how to build Crashpad on [Windows](https://github.com/BugSplat-Git/my-cmake-crasher/blob/main/scripts/build_windows_msvc.ps1), [macOS](https://github.com/BugSplat-Git/my-cmake-crasher/blob/main/scripts/build_macos.sh), and [Linux](https://github.com/BugSplat-Git/my-cmake-crasher/blob/main/scripts/build_linux.sh) with Chromium's [Depot Tools](https://www.chromium.org/developers/how-tos/depottools/).
...
<figure><img src="../../../../../.gitbook/assets/image (2).png" alt=""><figcaption><p>BugSplat Crash Details Page</p></figcaption></figure>
