...
For new BugSplat users, creating a new database can be accomplished via the Onboarding Tool. After creating a new account, users will be prompted to create a database. You can return to it any time by navigating to the [Onboarding Tool](https://app.bugsplat.com/v2/welcome).
